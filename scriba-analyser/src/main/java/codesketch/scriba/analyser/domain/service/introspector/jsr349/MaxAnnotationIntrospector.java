 ...
 */
@Singleton
public class MaxAnnotationIntrospector extends AbstractJSR349AnnotationIntrospector {
    ...
    public void instrospect(DocumentBuilder documentBuilder, Descriptor descriptor) {
        ...
        parameter.addConstraint(new NumericConstraint(valueOf(annotation.value()), "max"));
