 ...
 */
@Singleton
public class ApiPathAnnotationIntrospector implements Introspector {
    ...
    public void instrospect(DocumentBuilder documentBuilder, Descriptor descriptor) {
        ApiPath path = descriptor.getWrappedAnnotationAs(ApiPath.class);
        documentBuilder.addPathSegment(path.value(), descriptor.level());
    }
