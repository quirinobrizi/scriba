 ...
 */
@Singleton
public class ApiVerbAnnotationIntrospector implements Introspector {
    ...
    public void instrospect(DocumentBuilder documentBuilder, Descriptor decorator) {
        ApiVerb apiVerb = decorator.getWrappedAnnotationAs(ApiVerb.class);
        documentBuilder.setHttpMethod(apiVerb.value().name());
    }
     ...
     */
    @Override
    public Class<ApiVerb> type() {
        return ApiVerb.class;
    }
