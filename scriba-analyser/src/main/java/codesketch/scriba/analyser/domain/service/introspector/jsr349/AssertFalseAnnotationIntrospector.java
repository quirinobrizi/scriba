 ...
 */
@Singleton
public class AssertFalseAnnotationIntrospector extends AbstractJSR349AnnotationIntrospector {
    ...
    public void instrospect(DocumentBuilder documentBuilder, Descriptor descriptor) {
        ...
        parameter.constraints(new FalseContraint());
