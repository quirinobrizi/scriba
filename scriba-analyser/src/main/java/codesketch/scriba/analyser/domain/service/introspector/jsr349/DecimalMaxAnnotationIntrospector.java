 ...
 */
@Singleton
public class DecimalMaxAnnotationIntrospector extends AbstractJSR349AnnotationIntrospector {
    ...
    public void instrospect(DocumentBuilder documentBuilder, Descriptor descriptor) {
        ...
        parameter.constraints(new DecimalConstraint(annotation.value(), annotation.inclusive(),
                        "decimal-max"));
