...
import codesketch.scriba.analyser.domain.model.constraint.TrueConstraint;
 ...
 */
@Singleton
public class AssertTrueAnnotationIntrospector extends AbstractJSR349AnnotationIntrospector {
    ...
    public void instrospect(DocumentBuilder documentBuilder, Descriptor descriptor) {
        ...
        parameter.addConstraint(new TrueConstraint());
